...
# Example usage:
ages = [15, 35, 40, 22, 54, 38, 32, 44, 61, 61, 43, 57, 49, 46, 39, 25, 26, 55, 37, 41, 34, 64, 33, 29, 26]
...
# Example usage:
person = PersonAccount("Maryam", "Hassan")

# Adding income and expenses
person.add_income(150000, "Wages")
person.add_income(50000, "Advertisements")
person.add_expense(50000, "Accomodation")
person.add_expense(30000, "Utilities")
person.add_expense(20000, "Provitions")
